 ...
 * @author Lutfi
 */
public class PurcasheFormModel {
//    private String refnum,trans_date,id_supplier,total,type,flag,faktur;
    private String no, item_code,item_name,descrip,buy_price,qty,total_harga;
    JFXButton btn_edit,btn_delete;

    public PurcasheFormModel(String no, String item_code, String item_name, String descrip, String buy_price, String qty, String total_harga, JFXButton btn_edit, JFXButton btn_delete) {
        this.no = no;
