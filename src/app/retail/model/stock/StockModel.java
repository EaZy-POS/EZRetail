...
public class StockModel {
    private String NO,ITEMCODE,IDITEM,BARCODE,KODE,ITEMNAME,SUPID,SUPNAME,KATID,KAT,SUBKATID,SUBKAT,IDSAT,SATUAN,STOKMIN,KONVERSI,SATUANKE,HRGBELI,HARGAJUAL,FLAG,STOK;

    public StockModel(String NO, String ITEMCODE, String IDITEM, String BARCODE, String KODE, String ITEMNAME, String SUPID, String SUPNAME, String KATID, String KAT, String SUBKATID, String SUBKAT, String IDSAT, String SATUAN, String STOKMIN, String KONVERSI, String SATUANKE, String HRGBELI, String HARGAJUAL, String FLAG, String STOK) {
        this.NO = NO;
    ...
    public StockModel(String NO, String BARCODE, String KODE, String ITEMNAME, String SUPNAME, String KAT, String SATUAN, String HRGBELI, String STOK) {
        this.NO = NO;
        this.BARCODE = BARCODE;
        this.KODE = KODE;
        this.ITEMNAME = ITEMNAME;
